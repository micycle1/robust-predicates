 ...
 *
 * <p>This class is the runtime support library for the generated
 * {@link RobustPredicates} routines.
 */
public final class ExpansionArithmetic {
    ...
    /**
     * Default zero-elimination policy: eliminate zeros when the (static)
     * result length exceeds 16.
     */
     ...
     * Intermediate zero-elimination decisions use {@link #zeDefault} on the
     * (dynamic) sub-result lengths; {@code ze} controls the final result. Output region
    ...
    public static int expansionTimes(double[] e, int eBegin, int eEnd,
        ...
        // Merge the two adjacent sub-products; the inputs are copied out first
        // because fastExpansionSum requires a disjoint output region.
