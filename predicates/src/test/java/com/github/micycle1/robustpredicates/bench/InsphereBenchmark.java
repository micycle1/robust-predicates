...
/**
 * {@code insphere} throughput: this library vs. ProGAL's
 * {@link ExactJavaPredicates#insphere(double[], double[], double[], double[], double[])}.
...
@Fork(1)
@State(Scope.Thread)
public class InsphereBenchmark {
    ...
    public int robust() {
        double[][] t = next();
        return RobustPredicates.insphere(
    ...
    public double progal() {
        double[][] t = next();
        return progal.insphere(t[0], t[1], t[2], t[3], t[4]);
    }
}
