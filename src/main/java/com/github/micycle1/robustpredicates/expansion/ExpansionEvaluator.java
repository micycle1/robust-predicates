...
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.expansionSum;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.expansionTimes;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.fastExpansionSum;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.growExpansion;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.scaleExpansion;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.signOf;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.twoDiff;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.twoDiffTail;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.twoProduct;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.twoSquare;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.twoSum;
import static com.github.micycle1.robustpredicates.expansion.ExpansionArithmetic.zeDefault;

/**
 * Exact sign evaluation of an expression via expansion arithmetic
 * (port of the evaluation core shared by {@code stage_b.hpp} and
 * {@code stage_d.hpp}).
 *
            ...
            switch (node.op()) {
                case SUM, DIFFERENCE -> {
                    ...
                    if (leftLeaf && rightLeaf) {
                        ...
                        int li = evalIndex.get(left);
                        int ri = evalIndex.get(right);
                        // Fast-expansion-sum policy on static sizes, as in C++.
